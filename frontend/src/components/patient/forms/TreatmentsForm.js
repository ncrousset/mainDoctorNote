...
export class MedicalTreatmentForm extends Component {

    state = this.props.medicalTreatment;

    static propTypes = {
        onClose: PropTypes.func.isRequired,
        addMedicalTreatment: PropTypes.func.isRequired,
        editMedicalTreatment: PropTypes.func.isRequired,
        medicalTreatment: PropTypes.object.isRequired,
    ...
    onSubmit = event => {
        ...
        if (this.props.edit) {
            this.props.editMedicalTreatment(this.props.medicalTreatment, this.state)
                .then((response) => {
                    this.props.onClose()
                })
                .catch(error => {
            ...
            this.props.addMedicalTreatment(this.props.patient.id, this.state)
                .then((response) => {
                    this.props.onClose()
                })
                .catch(error => {
...
export default connect(mapStateToProps, mapStateFuntion)(MedicalTreatmentForm)
