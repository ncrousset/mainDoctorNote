...
export class MedicalStudiesForm extends Component {

    state = this.props.medicalStudy;

    static propTypes = {
        onClose: PropTypes.func.isRequired,
        addMedicalStudy: PropTypes.func.isRequired,
        editMedicalStudy: PropTypes.func.isRequired,
        medicalStudy: PropTypes.object.isRequired,
    ...
    onSubmit = event => {
        ...
        if (this.props.edit) {
            this.props.editMedicalStudy(this.props.medicalStudy, this.state)
                .then((response) => {
                    this.props.onClose()
                })
                .catch(error => {
            ...
            this.props.addMedicalStudy(this.props.patient.id, this.state)
                .then((response) => {
                    this.props.onClose()
                })
                .catch(error => {
...
export default connect(mapStateToProps, mapStateFuntion)(MedicalStudiesForm)
