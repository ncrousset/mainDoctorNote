...
export const GET_MEDICAL_STUDIES = 'GET_MEDICAL_STUDIES';
export const ADD_MEDICAL_STUDY = 'ADD_MEDICAL_STUDY';
export const DELETE_MEDICAL_STUDY  = 'DELETE_MEDICAL_STUDY';
export const UPDATE_MEDICAL_STUDY  = 'UPDATE_MEDICAL_STUDY';

export const GET_MEDICAL_TREATMENTS = 'GET_MEDICAL_TREATMENTS';
export const ADD_MEDICAL_TREATMENT = 'ADD_MEDICAL_TREATMENT';
export const DELETE_MEDICAL_TREATMENT  = 'DELETE_MEDICAL_TREATMENT';
export const UPDATE_MEDICAL_TREATMENT = 'UPDATE_MEDICAL_TREATMENT';